...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if manual == False:
            ...
            try:
                if paramètres['auto_ffilter']:
                    await auto_filter(client, message)
            except KeyError:
                grpid = await active_connection(str(message.from_user.id))
                await save_group_paramètres(grpid, 'auto_ffilter', True)
                paramètres = await get_paramètres(message.chat.id)
                if paramètres['auto_ffilter']:
                    await auto_filter(client, message) 
    else:
        ...
        if total_results == 0:
            ...
            return await message.reply_text(f"<b>Hᴇʏ {message.from_user.mention},\n\nᴠᴏᴛʀᴇ ᴅᴇᴍᴀɴᴅᴇ ᴇꜱᴛ ᴅᴇᴊᴀ ᴅɪꜱᴘᴏɴɪʙʟᴇ ✅\n\n📂 ꜰɪᴄʜɪᴇʀꜱ ᴛʀᴏᴜᴠᴇꜱ : {str(total_results)}\n ʀᴇᴄʜᴇʀᴄʜᴇ :</b> <code>{search}</code>\n\n<b>‼️ ᴄ'ᴇꜱᴛ ᴜɴ <u>ɢʀᴏᴜᴘᴇ ᴅᴇ ꜱᴜᴘᴘᴏʀᴛ</u>, ᴠᴏᴜꜱ ɴᴇ ᴘᴏᴜᴠᴇᴢ ᴘᴀꜱ ᴏʙᴛᴇɴɪʀ ᴅᴇ ꜰɪᴄʜɪᴇʀꜱ ɪᴄɪ...\n\n📝 ʀᴇᴄʜᴇʀᴄʜᴇᴢ ɪᴄɪ : 👇</b>",   
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("ʀᴇᴊᴏɪɴᴅʀᴇ ᴇᴛ ʀᴇᴄʜᴇʀᴄʜᴇʀ ɪᴄɪ", url=GRP_LNK)]]))
    ...
    try:
        ...
        if pm_search:
            ...
            await message.reply_text(
             text=f"<b>🙋 ʜᴇʏ {user} 😍 ,\n\n𝑽𝒐𝒖𝒔 𝒏𝒆 𝒑𝒐𝒖𝒗𝒆𝒛 𝒄𝒉𝒆𝒓𝒄𝒉𝒆𝒓 𝒅𝒆𝒔 𝒇𝒊𝒍𝒎𝒔 𝒒𝒖𝒆 𝒅𝒂𝒏𝒔 𝒏𝒐𝒕𝒓𝒆 𝒈𝒓𝒐𝒖𝒑𝒆. 𝑽𝒐𝒖𝒔 𝒏'ê𝒕𝒆𝒔 𝒑𝒂𝒔 𝒂𝒖𝒕𝒐𝒓𝒊𝒔é à 𝒄𝒉𝒆𝒓𝒄𝒉𝒆𝒓 𝒆𝒏 𝑴𝑷. 𝑹𝒆𝒋𝒐𝒊𝒈𝒏𝒆𝒛 𝒏𝒐𝒕𝒓𝒆 𝒈𝒓𝒐𝒖𝒑𝒆 𝒆𝒏 𝒄𝒍𝒊𝒒𝒖𝒂𝒏𝒕 𝒔𝒖𝒓 𝒍𝒆 𝒃𝒐𝒖𝒕𝒐𝒏 𝑫𝑬𝑴𝑨𝑵𝑫𝑬𝑹 𝑰𝑪𝑰 𝒄𝒊-𝒅𝒆𝒔𝒔𝒐𝒖𝒔 👇</b>",   
             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴅᴇᴍᴀɴᴅᴇʀ ɪᴄɪ ", url=GRP_LNK)]])
            )
...
async def refercall(bot, query):
    btn = [[
        InlineKeyboardButton("lien d'invitation", url=f'https://telegram.me/share/url?url=https://t.me/{bot.me.username}?start=reff_{query.from_user.id}&text=Bonjour%20!%20D%C3%A9couvrez%20un%20bot%20offrant%20une%20biblioth%C3%A8que%20illimit%C3%A9e%20de%20films%20et%20s%C3%A9ries.%20%F0%9F%98%83'),
    ...
    await query.message.edit_text(
        text=f'Voici votre lien de parrainage :\n\nhttps://t.me/{bot.me.username}?start=reff_{query.from_user.id}\n\nPartagez ce lien avec vos amis. A chaque inscription, vous gagnez 10 points de parrainage. Après 100 points, vous obtenez 1 mois de premium gratuit.',
...
async def next_page(bot, query):
    ...
    pre = 'filep' if paramètres['file_secure'] else 'file'
    if paramètres['button']:
        ...
        btn.insert(0, 
            [
                InlineKeyboardButton("⇈ ꜱᴇʟᴇᴄᴛɪᴏɴɴᴇᴢ ɪᴄɪ ⇈", 'reqinfo')
            ]
        )
        btn.insert(0, 
            [ 
                InlineKeyboardButton(f'ǫᴜᴀʟɪᴛᴇ', callback_data=f"qualities#{key}"),
                InlineKeyboardButton("ʟᴀɴɢᴜᴇ", callback_data=f"languages#{key}"),
                InlineKeyboardButton("ꜱᴀɪꜱᴏɴ",  callback_data=f"seasons#{key}")
            ]
        )
        btn.insert(0, [
            InlineKeyboardButton("ꜱᴀɴꜱ ᴘᴜʙ", url=f"https://t.me/{temp.U_NAME}?start=premium"),
    ...
    try:
        ...
        await save_group_paramètres(query.message.chat.id, 'max_btn', True)
        if 0 < offset <= 10:
            off_set = 0
        elif offset == 0:
            off_set = None
    ...
    if not paramètres["button"]:
        ...
        cap = await get_cap(paramètres, remaining_seconds, files, query, total, search)
        try:
...
async def qualities_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(
        ...
        [
            InlineKeyboardButton(
                text="⇊ ꜱᴇʟᴇᴄᴛɪᴏɴɴᴇᴢ ʟᴀ ǫᴜᴀʟɪᴛᴇ ⇊", callback_data="ident"
            )
        ],
    )
...
async def filter_qualities_cb_handler(client: Client, query: CallbackQuery):
    ...
    if not paramètres["button"]:
        ...
        time_difference = timedelta(hours=cur_time.hour, minutes=cur_time.minute, seconds=(cur_time.second+(cur_time.microsecond/1000000))) - timedelta(hours=curr_time.hour, minutes=curr_time.minute, seconds=(curr_time.second+(curr_time.microsecond/1000000)))
        remaining_seconds = "{:.2f}".format(time_difference.total_seconds())
        cap = await get_cap(paramètres, remaining_seconds, files, query, total_results, search)
        try:
            await query.message.edit_text(text=cap, reply_markup=InlineKeyboardMarkup(btn), disable_web_page_preview=True)
        except MessageNotModified:
            pass
...
async def languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(
        ...
        [
            InlineKeyboardButton(
                text="⇊ ꜱᴇʟᴇᴄᴛɪᴏɴɴᴇᴢ ʟᴀ ʟᴀɴɢᴜᴇ ⇊", callback_data="ident"
            )
        ],
    )
    req = query.from_user.id
...
async def seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(
        ...
        [
            InlineKeyboardButton(
                text="⇊ ꜱᴇʟᴇᴄᴛɪᴏɴɴᴇᴢ ʟᴀ ꜱᴀɪꜱᴏɴ ⇊", callback_data="ident"
            )
        ],
    )
    req = query.from_user.id
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    if paramètres["button"]:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ꜱᴀɴꜱ ᴘᴜʙ", url=f"https://t.me/{temp.U_NAME}?start=premium"),
            InlineKeyboardButton("ꜱᴇʟᴇᴄᴛɪᴏɴɴᴇʀ ᴀ ɴᴏᴜᴠᴇᴀᴜ", callback_data=f"seasons#{key}")
        ])
    else:
        btn = []
        btn.insert(0, 
        ...
        btn.insert(0, [
            InlineKeyboardButton("ꜱᴀɴꜱ ᴘᴜʙ", url=f"https://t.me/{temp.U_NAME}?start=plan"),
            InlineKeyboardButton("ᴇɴᴠᴏʏᴇʀ ᴛᴏᴜᴛ", callback_data=f"sendfiles#{key}")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        # Nouveau système de vérification d'accès (session + premium)
        access = await get_user_access(clicked)
        ...
        channels = (await get_paramètres(int(query.from_user.id))).get('fsub')  
        if channels:
            btn = await is_subscribed(client, query, channels)
            if btn:
                await query.answer(
                    f"👋 Salut {query.from_user.first_name},\n\n"
                    "ᴠᴏᴜꜱ ɴ'ᴀᴠᴇᴢ ᴘᴀꜱ ʀᴇᴊᴏɪɴᴛ ᴛᴏᴜꜱ ʟᴇꜱ ᴄᴀɴᴀᴜx ᴅᴇ ᴍɪꜱᴇ ᴀ ᴊᴏᴜʀ ʀᴇǫᴜɪꜱ.\n"
                    "ᴠᴇᴜɪʟʟᴇᴢ ʀᴇᴊᴏɪɴᴅʀᴇ ᴄʜᴀǫᴜᴇ ᴄᴀɴᴀʟ ᴄɪ-ᴅᴇꜱꜱᴏᴜꜱ ᴇᴛ ʀᴇᴇꜱꜱᴀʏᴇᴢ.\n\n",
                    show_alert=True
                )
        ...
        await query.message.edit_text(f"<b>Recherche des fichiers pour votre requête {keyword} dans la base... Veuillez patienter...</b>")
        files, total = await get_bad_files(keyword)
        await query.message.edit_text("<b>ʟᴇ ᴘʀᴏᴄᴇꜱꜱᴜꜱ ᴅᴇ ꜱᴜᴘᴘʀᴇꜱꜱɪᴏɴ ᴅᴇᴍᴀʀʀᴇ ᴅᴀɴꜱ 5 ꜱᴇᴄᴏɴᴅᴇꜱ !</b>")
            ...
            buttons = [
                [
                    InlineKeyboardButton('ʀᴇꜱᴜʟᴛ ᴘᴀɢᴇ',
                                         callback_data=f'setgs#button#{paramètres["button"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ʙᴜᴛᴛᴏɴ' if paramètres["button"] else 'ᴛᴇxᴛ',
                                         callback_data=f'setgs#button#{paramètres["button"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ꜰɪʟᴇ ꜱᴇɴᴅ ᴍᴏᴅᴇ', callback_data=f'setgs#botpm#{paramètres["botpm"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ꜱᴛᴀʀᴛ' if paramètres["botpm"] else 'ᴀᴜᴛᴏ',
                                         callback_data=f'setgs#botpm#{paramètres["botpm"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ꜰɪʟᴇ ꜱᴇᴄᴜʀᴇ',
                                         callback_data=f'setgs#file_secure#{paramètres["file_secure"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ᴇɴᴀʙʟᴇ' if paramètres["file_secure"] else 'ᴅɪꜱᴀʙʟᴇ',
                                         callback_data=f'setgs#file_secure#{paramètres["file_secure"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ɪᴍᴅʙ ᴘᴏꜱᴛᴇʀ', callback_data=f'setgs#imdb#{paramètres["imdb"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ᴇɴᴀʙʟᴇ' if paramètres["imdb"] else 'ᴅɪꜱᴀʙʟᴇ',
                                         callback_data=f'setgs#imdb#{paramètres["imdb"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ꜱᴘᴇʟʟ ᴄʜᴇᴄᴋ',
                                         callback_data=f'setgs#spell_check#{paramètres["spell_check"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ᴇɴᴀʙʟᴇ' if paramètres["spell_check"] else 'ᴅɪꜱᴀʙʟᴇ',
                                         callback_data=f'setgs#spell_check#{paramètres["spell_check"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ᴡᴇʟᴄᴏᴍᴇ ᴍꜱɢ', callback_data=f'setgs#welcome#{paramètres["welcome"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ᴇɴᴀʙʟᴇ' if paramètres["welcome"] else 'ᴅɪꜱᴀʙʟᴇ',
                                         callback_data=f'setgs#welcome#{paramètres["welcome"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ',
                                         callback_data=f'setgs#auto_delete#{paramètres["auto_delete"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ᴇɴᴀʙʟᴇ' if paramètres["auto_delete"] else 'ᴅɪꜱᴀʙʟᴇ',
                                         callback_data=f'setgs#auto_delete#{paramètres["auto_delete"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ',
                                         callback_data=f'setgs#auto_ffilter#{paramètres["auto_ffilter"]}#{str(grp_id)}'),
                    InlineKeyboardButton('ᴇɴᴀʙʟᴇ' if paramètres["auto_ffilter"] else 'ᴅɪꜱᴀʙʟᴇ',
                                         callback_data=f'setgs#auto_ffilter#{paramètres["auto_ffilter"]}#{str(grp_id)}')
                ],
                [
        ...
        if query.from_user.id in ADMINS:
            ...
            reply_markup = InlineKeyboardMarkup(btn)
            await query.message.edit_reply_markup(reply_markup)
            await query.answer("ᴠᴏɪᴄɪ ʟᴇꜱ ᴏᴘᴛɪᴏɴꜱ !")
        else:
            await query.answer("ᴠᴏᴜꜱ ɴ'ᴀᴠᴇᴢ ᴘᴀꜱ ʟᴇꜱ ᴅʀᴏɪᴛꜱ ꜱᴜꜰꜰɪꜱᴀɴᴛꜱ ᴘᴏᴜʀ ꜰᴀɪʀᴇ ᴄᴇʟᴀ !", show_alert=True)
        ...
        ident, from_user = query.data.split("#")
        btn = [[
                InlineKeyboardButton("⚠️ ɪɴᴅɪꜱᴘᴏɴɪʙʟᴇ ⚠️", callback_data=f"unalert#{from_user}")
              ]]
        btn2 = [[
        ...
        ident, from_user = query.data.split("#")
        btn = [[
                InlineKeyboardButton("📌 ᴘᴀꜱ ᴇɴᴄᴏʀᴇ ꜱᴏʀᴛɪ 📌", callback_data=f"unalert#{from_user}")
              ]]
        btn2 = [[
                 InlineKeyboardButton('ʀᴇᴊᴏɪɴᴅʀᴇ ʟᴇ ᴄᴀɴᴀʟ', url=link.invite_link),
                 InlineKeyboardButton("ᴠᴏɪʀ ʟᴇ ꜱᴛᴀᴛᴜᴛ", url=f"{query.message.link}")
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("ᴍᴀʀǫᴜᴇ ᴄᴏᴍᴍᴇ ɪɴᴅɪꜱᴘᴏɴɪʙʟᴇ !")
            try:
                await client.send_message(chat_id=int(from_user), text=f"<u>{content}</u>\n\n<b>Hᴇʏ {user.mention}, ʟᴇ ꜰɪʟᴍ ᴅᴇᴍᴀɴᴅᴇ ɴ'ᴇꜱᴛ ᴘᴀꜱ ᴇɴᴄᴏʀᴇ ꜱᴏʀᴛɪ. ɴᴏꜱ ᴍᴏᴅᴇʀᴀᴛᴇᴜʀꜱ ɴᴇ ᴘᴇᴜᴠᴇɴᴛ ᴘᴀꜱ ʟ'ᴇɴᴠᴏʏᴇʀ.</b>", reply_markup=InlineKeyboardMarkup(btn2))
            except UserIsBlocked:
                await client.send_message(chat_id=int(SUPPORT_CHAT_ID), text=f"<u>{content}</u>\n\n<b>Hᴇʏ {user.mention}, ʟᴇ ꜰɪʟᴍ ᴅᴇᴍᴀɴᴅᴇ ɴ'ᴇꜱᴛ ᴘᴀꜱ ᴇɴᴄᴏʀᴇ ꜱᴏʀᴛɪ. ɴᴏꜱ ᴍᴏᴅᴇʀᴀᴛᴇᴜʀꜱ ɴᴇ ᴘᴇᴜᴠᴇɴᴛ ᴘᴀꜱ ʟ'ᴇɴᴠᴏʏᴇʀ.\n\nɴᴏᴛᴇ : ᴄᴇ ᴍᴇꜱꜱᴀɢᴇ ᴇꜱᴛ ᴇɴᴠᴏʏᴇ ᴅᴀɴꜱ ᴄᴇ ɢʀᴏᴜᴘᴇ ᴄᴀʀ ᴠᴏᴜꜱ ᴀᴠᴇᴢ ʙʟᴏǫᴜᴇ ʟᴇ ʙᴏᴛ. ᴘᴏᴜʀ ʀᴇᴄᴇᴠᴏɪʀ ᴇɴ ᴍᴘ, ᴅᴇʙʟᴏǫᴜᴇᴢ ʟᴇ ʙᴏᴛ.</b>", reply_markup=InlineKeyboardMarkup(btn2))
        else:
            await query.answer("ᴠᴏᴜꜱ ɴ'ᴀᴠᴇᴢ ᴘᴀꜱ ʟᴇꜱ ᴅʀᴏɪᴛꜱ ꜱᴜꜰꜰɪꜱᴀɴᴛꜱ ᴘᴏᴜʀ ꜰᴀɪʀᴇ ᴄᴇʟᴀ !", show_alert=True)
        ...
        ident, from_user = query.data.split("#")
        btn = [[
                InlineKeyboardButton("♨️ ᴛᴀᴘᴇᴢ ʟ'ᴏʀᴛʜᴏɢʀᴀᴘʜᴇ ᴄᴏʀʀᴇᴄᴛᴇ ♨️", callback_data=f"unalert#{from_user}")
              ]]
        btn2 = [[
                 InlineKeyboardButton('ʀᴇᴊᴏɪɴᴅʀᴇ ʟᴇ ᴄᴀɴᴀʟ', url=link.invite_link),
                 InlineKeyboardButton("ᴠᴏɪʀ ʟᴇ ꜱᴛᴀᴛᴜᴛ", url=f"{query.message.link}")
        ...
        if query.from_user.id in ADMINS:
            ...
            try:
                await client.send_message(chat_id=int(from_user), text=f"<u>{content}</u>\n\n<b>Hᴇʏ {user.mention}, L'orthographe du film demandé est incorrecte. Veuillez taper l'orthographe correcte du nom du film et réessayer.</b>", reply_markup=InlineKeyboardMarkup(btn2))
            except UserIsBlocked:
                await client.send_message(chat_id=int(SUPPORT_CHAT_ID), text=f"<u>{content}</u>\n\n<b>Hᴇʏ {user.mention}, L'orthographe du film demandé est incorrecte. Veuillez taper l'orthographe correcte du nom du film et réessayer.\n\nɴᴏᴛᴇ : ᴄᴇ ᴍᴇꜱꜱᴀɢᴇ ᴇꜱᴛ ᴇɴᴠᴏʏᴇ ᴅᴀɴꜱ ᴄᴇ ɢʀᴏᴜᴘᴇ ᴄᴀʀ ᴠᴏᴜꜱ ᴀᴠᴇᴢ ʙʟᴏǫᴜᴇ ʟᴇ ʙᴏᴛ. ᴘᴏᴜʀ ʀᴇᴄᴇᴠᴏɪʀ ᴇɴ ᴍᴘ, ᴅᴇʙʟᴏǫᴜᴇᴢ ʟᴇ ʙᴏᴛ.</b>", reply_markup=InlineKeyboardMarkup(btn2))
        else:
            await query.answer("ᴠᴏᴜꜱ ɴ'ᴀᴠᴇᴢ ᴘᴀꜱ ʟᴇꜱ ᴅʀᴏɪᴛꜱ ꜱᴜꜰꜰɪꜱᴀɴᴛꜱ ᴘᴏᴜʀ ꜰᴀɪʀᴇ ᴄᴇʟᴀ !", show_alert=True)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ʀᴇᴄʜᴇʀᴄʜᴇ ʜᴇʀᴇ 🔎", url=GRP_LNK)
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
            ...
            await query.message.edit_text(f"<b><strike>{content}</strike></b>")
            await query.message.edit_reply_markup(reply_markup)
            await query.answer("ᴍᴀʀǫᴜᴇ ᴄᴏᴍᴍᴇ ᴇɴᴠᴏʏᴇ !")
            try:
        ...
        try:
            ...
            await log_msg.reply_text(
                ...
                quote=True,
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🚀 Téléchargement Rapide 🚀", url=lazy_download),  # we download Link
       ...
       #@codeflix_bots
        ...
        buttons = [[
            InlineKeyboardButton('• ᴄᴏᴍᴍᴀɴᴅᴇꜱ ᴀᴅᴍɪɴ •', callback_data='admic')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('⚜️ ᴄʟɪǫᴜᴇᴢ ɪᴄɪ ᴘᴏᴜʀ ʟ\'ᴇꜱꜱᴀɪ ɢʀᴀᴛᴜɪᴛ', callback_data="give_trial")
        ],[
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='other'),
            InlineKeyboardButton('1 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='broze')
        ],[
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('🔐 ᴄʟɪǫᴜᴇᴢ ɪᴄɪ ᴘᴏᴜʀ ᴀᴄʜᴇᴛᴇʀ ʟᴇ ᴘʀᴇᴍɪᴜᴍ', callback_data='purchase')
        ],[
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='free'),
            InlineKeyboardButton('2 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='silver')
        ],[
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='broze'),
            InlineKeyboardButton('3 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='gold')
        ],[
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
#Deendayal403
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='silver'),
            InlineKeyboardButton('4 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='platinum')
        ],[
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='gold'),
            InlineKeyboardButton('5 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='diamond')
        ],[
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='platinum'),
            InlineKeyboardButton('6 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='other')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⋞ ʀᴇᴛᴏᴜʀ', callback_data='diamond'),
            InlineKeyboardButton('7 / 7', callback_data='pagesn1'),
            InlineKeyboardButton('ꜱᴜɪᴠᴀɴᴛ ⋟', callback_data='free')
        ],[
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='premium_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        reply_markup = InlineKeyboardMarkup([buttons, [InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='help')]])
        await query.message.edit_text(
            text=commands[page],
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⇋ ʀᴇᴛᴏᴜʀ ⇋', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴛᴏᴜʀ', callback_data='main'),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', callback_data='group_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        if status == "True":
            ...
            await save_group_paramètres(grpid, set_type, True)

        paramètres = await get_paramètres(grpid)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            search = message.text         
            search = search.lower()
            # Log de la recherche pour l'historique Mini App
            try:
                await log_search(message.from_user.id, search)
            except Exception:
                pass
    ...
    if offset != "":
        ...
        try:
            ...
            await save_group_paramètres(message.chat.id, 'max_btn', True)
            btn.append(
                [InlineKeyboardButton("ᴘᴀɢᴇ", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/10)}",callback_data="pages"), InlineKeyboardButton(text="ɴᴇxᴛ ⋟",callback_data=f"next_{req}_{key}_{offset}")]
            )
    else:
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            await m.delete()
            try:
                if paramètres['auto_delete']:
                    await asyncio.sleep(DELETE_TIME)
                    await hehe.delete()
                    await message.delete()
            except KeyError:
                await save_group_paramètres(message.chat.id, 'auto_delete', True)
                await asyncio.sleep(DELETE_TIME)
                await hehe.delete()
                await message.delete()
                    ...
                    if fileid == "None":
                        if btn == "[]":
                            joelkb = await client.send_message(
                                ...
                                reply_text, 
                                disable_web_page_preview=True,
                                protect_content=True if paramètres["file_secure"] else False,
                            ...
                            try:
                                if paramètres['auto_ffilter']:
                                    ...
                                    try:
                                        ...
                                        grpid = await active_connection(str(message.from_user.id))
                                        await save_group_paramètres(grpid, 'auto_delete', True)
                                        paramètres = await get_paramètres(message.chat.id)
                                        if paramètres['auto_delete']:
                                            await joelkb.delete()
                                else:
