...
async def link_handler(Mbot, message):
    ...
    try:
        ...
        try:
            ...
            await message.reply(f"400: Désolé, impossible de trouver. Assurez-vous que c'est public :)")
        except Exception as e:
          ...
          #     await message.reply(tracemsg)
            ##optinal 
            await message.reply(f"400: Désolé, impossible de trouver. Essayez un autre ou signalez à @cosmic_freak")
