...
async def who_is(client, message):
    ...
    dc_id = from_user.dc_id or "[L'utilisateur n'a pas de photo valide]"
    message_out_str += f"<b>➲Centre de données :</b> <code>{dc_id}</code>\n"
    message_out_str += f"<b>➲Nom d'utilisateur :</b> @{username}\n"
    message_out_str += f"<b>➲𝖫𝗂𝗇𝗄 utilisateur :</b> <a href='tg://user?id={from_user.id}'><b>Cliquez ici</b></a>\n"
