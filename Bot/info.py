...
# Mini App JKS — remplace cette URL par l'URL réelle de ta Mini App déployée
MINI_APP_URL = environ.get('MINI_APP_URL', 'https://t.me/TON_BOT_USERNAME/app')
