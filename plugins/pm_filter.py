...
async def years_cb_handler(client: Client, query: CallbackQuery):
    ...
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Retour Arrière↭", callback_data=f"fy#homepage#{key}")])
...
async def episodes_cb_handler(client: Client, query: CallbackQuery):
    ...
    req = query.from_user.id
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Retour Arrière↭", callback_data=f"fe#homepage#{key}")])
...
async def languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    req = query.from_user.id
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Retour Arrière​↭", callback_data=f"fl#homepage#{key}")])
...
async def seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    req = query.from_user.id
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Retour Arrière​↭", callback_data=f"next_{req}_{key}_{offset}")])
     ...
     #   if not search:
      ...
      #      return
        ...
        buttons = [[
            ...
            InlineKeyboardButton('JessiKaPay', url="t.me/JessiKaPay")
        ],[
