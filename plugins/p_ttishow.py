...
async def leave_a_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat,
            text='<b>Bonjour Friends, \nMy admin has told me to leave from group, so i go! If you wanna add me again contact my Groupe de support or My Proprietaire</b>',
            reply_markup=reply_markup,
        )
